...
_Use the least amount of embodied carbon possible._
...
- Cloud computing is more energy efficient than an on-premise server as it can apply demand shifting as well as demand shaping.
